...
const vendorFAQs = [
  ...
  {
    question: "Hva koster det å bruke Evendi?",
    answer: "Evendi er gratis for leverandører å komme i gang! Vi tilbyr forskjellige abonnementer basert på dine behov. Se 'Abonnement' i Dashboard for mer informasjon om priser og funksjoner. Det er ingen skjulte kostnader.",
    icon: "dollar-sign",
    category: "vendor" as const,
    sortOrder: 8,
  },
  {
    question: "Hvordan kontakter jeg Evendi support?",
    answer: "Du kan kontakte oss via 'Evendi Support'-knappen i Dashboard. Vi svarer vanligvis innen 24 timer. For akutte saker, send e-post til support@evendi.no. Du kan også sjekke Hjelp & FAQ for raske svar, dokumentasjonen for detaljerte guider, og videoguider for visuelle instruksjoner.",
    icon: "help-circle",
    category: "vendor" as const,
    sortOrder: 9,
  },
...
const coupleFAQs = [
  ...
  },
  {
    ...
    answer: "Gå til 'Profil'-fanen og trykk på 'Meldinger'. Her får du en oversikt over alle samtaler med leverandører, kan ringe eller sende SMS til viktige personer i bryllupsfølget, og kontakte Evendi Support direkte. Du kan også bruke 'Hjelp & FAQ' for raske svar.",
    icon: "message-square",
    category: "couple" as const,
    sortOrder: 7,
  },
  ...
  {
    question: "Kan jeg bruke Evendi gratis?",
    answer: "Ja! Evendi er helt gratis for brudepar. Du får tilgang til alle planleggingsverktøy, leverandørsøk, chat med leverandører, inspirasjon, gjesteliste, bordkart, budsjett, sjekkliste og alle andre funksjoner uten noen kostnader.",
    icon: "check-circle",
    category: "couple" as const,
    sortOrder: 12,
  },
  ...
  {
    question: "Hvordan kontakter jeg Evendi for hjelp?",
    answer: "Du har flere muligheter: 1) Gå til 'Profil' > 'Meldinger' > 'Evendi Support' for direkte chat, 2) Bruk 'Hjelp & FAQ' for raske svar, 3) Send tilbakemelding via 'Tilbakemelding til Evendi', eller 4) Send e-post til support@evendi.no. Vi svarer vanligvis innen 24 timer.",
    icon: "headphones",
    category: "couple" as const,
    sortOrder: 17,
  },
